...
import { ArrowRight, Sparkles, Zap, Lock, Palette, Image, Contrast, Layers, Check, Star, Users, Download } from 'lucide-react';
...
const samplePalettes: SavedPalette[] = [{
  ...
  id: '3',
  colors: ['#6C5CE7', '#A29BFE', '#74B9FF', '#81ECEC', '#00CEC9'],
  savedAt: Date.now(),
  name: 'Ocean Dreams'
}, {
  id: '4',
  colors: ['#FD79A8', '#F8B500', '#00B894', '#00CEC9', '#0984E3'],
  savedAt: Date.now(),
  name: 'Vibrant Pop'
}, {
  id: '5',
  colors: ['#E17055', '#FDCB6E', '#00B894', '#0984E3', '#6C5CE7'],
  savedAt: Date.now(),
  name: 'Rainbow Bright'
}, {
  id: '6',
  ...
  return <div className="min-h-screen bg-background flex flex-col">
      ...
      <section className="relative pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          repeat: Infinity,
          ease: 'easeInOut'
        }} className="absolute -top-40 -right-40 w-64 sm:w-96 h-64 sm:h-96 rounded-full blur-3xl opacity-30" style={{
          backgroundColor: heroColors[0]
        }} />
          <motion.div animate={{
          x: [0, -20, 0],
          y: [0, 30, 0]
          ...
          repeat: Infinity,
          ease: 'easeInOut'
        }} className="absolute -bottom-40 -left-40 w-64 sm:w-96 h-64 sm:h-96 rounded-full blur-3xl opacity-30" style={{
          backgroundColor: heroColors[2]
        }} />
        </div>

        <div className="container mx-auto max-w-5xl relative z-10 px-0">
          <motion.div initial={{
          opacity: 0,
          y: 30
        }} animate={{
          ...
          delay: 0.2
            ...
            <div className="flex h-24 sm:h-32 md:h-40 rounded-2xl overflow-hidden shadow-2xl">
              {heroColors.map((color, i) => <motion.div key={i} className="flex-1 transition-colors duration-700" style={{
      ...
      <section className="py-16 sm:py-20 px-4 bg-secondary/30">
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            step: '01',
            title: 'Generate',
            desc: 'Press spacebar or click generate to create random palettes instantly.'
          }, {
            step: '02',
            title: 'Customize',
            desc: 'Lock colors you love, adjust with the color picker, and fine-tune.'
          }, {
            step: '03',
            title: 'Export',
            desc: 'Download as image, copy CSS code, or share with a unique link.'
      ...
      <section className="py-16 sm:py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {samplePalettes.map((palette, i) => <PaletteCard key={palette.id} palette={palette} index={i} />)}
          </div>
